    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menuItem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='foodDeliveryFunctionalities.menuitem')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='foodDeliveryFunctionalities.order')),
            ],
        ),
        migrations.AddField(
            model_name='order',
            name='item',
            field=models.ManyToManyField(through='foodDeliveryFunctionalities.Orderitem', to='foodDeliveryFunctionalities.menuitem'),
        ),
        migrations.AddField(
            model_name='order',
            name='user',
        ...
        migrations.AddField(
            model_name='menuitem',
            name='restuarent',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='menuItem', to='foodDeliveryFunctionalities.restuarent'),
        ),
    ]
